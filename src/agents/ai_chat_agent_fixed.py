...
class AIChatAgent:
    ...
    def __init__(self):
        ...
        # Initialize the OpenAI client with only the required parameter to avoid proxy issues
        # The newer OpenAI library doesn't accept proxy parameters in the constructor
